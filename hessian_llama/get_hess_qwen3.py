...
from hessian_llama.custom_linear_A import CustomLinear as CLA
...
for pit in range(args.power_iters):
    ...
    if local_rank == 0:
        ...
        dataset = load_from_disk('/local_ssd2/anazir/.cache/huggingface/datasets/redpajama_70k').shuffle(args.seed)
        dl = iter(
